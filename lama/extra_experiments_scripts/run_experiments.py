...
LMs = [
    ...
    },
    {
        ...
        "models_names": ["roberta"],
        "roberta_model_name": "model.pt",
        "roberta_model_dir": "roberta.large",
        "roberta_vocab_name": "dict.txt"
    },
    {
        "lm": "distillbert",
        "label": "distillbert_base",
        "models_names": ["distillbert"],
    ...
    # configs for few-shot experiments
    # {
    #     "lm": "bert",
    #     "label": "bert_base",
    #     "models_names": ["bert"],
    ...
    #     "models_names": ["bert"],
    #     "bert_model_name": "bert-base-cased",
    #     "bert_model_dir": "lm_output/death_place_10",
    # },
    # {
    #     "lm": "bert",
    #     "label": "bert_base",
    #     "models_names": ["bert"],
    #     "bert_model_name": "bert-base-cased",
    #     "bert_model_dir": "lm_output/death_place_50",
    # },
    # {
    #     "lm": "bert",
    #     "label": "bert_base",
    #     "models_names": ["bert"],
    #     "bert_model_name": "bert-base-cased",
    #     "bert_model_dir": "lm_output/death_place_100",
    # },
    # {
    #     "lm": "bert",
    #     "label": "bert_base",
    #     "models_names": ["bert"],
    #     "bert_model_name": "bert-base-cased",
    #     "bert_model_dir": "lm_output/death_place_200",
    # },
    # {
    #     "lm": "bert",
    #     "label": "bert_base",
    #     "models_names": ["bert"],
    #     "bert_model_name": "bert-base-cased",
    #     "bert_model_dir": "lm_output/death_place_300",
    # },
    # {
    #     "lm": "bert",
    #     "label": "bert_base",
    #     "models_names": ["bert"],
    #     "bert_model_name": "bert-base-cased",
    #     "bert_model_dir": "lm_output/death_place_400",
    # },
    # {
    #     "lm": "bert",
    #     "label": "bert_base",
    #     "models_names": ["bert"],
    #     "bert_model_name": "bert-base-cased",
    #     "bert_model_dir": "lm_output/death_place_500",
    # },
]
